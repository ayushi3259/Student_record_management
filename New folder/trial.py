...
class STUDENT_RESULT_SYSTEM:
    ...
    def ADD_STUDENT_INFORMATION():
        while(True):
            ...
            print("ENTER OVERALL RESULT(GRADING SYSTEM ) :", end=" ")
            RESULT = input().upper()
            ...
            if MOBILE_NUMBER_LEN < 10:
                ...
                print("\n")
                print("WANT TO ADD ANY OTHER STUDENT INFORMATION ", end=" ")


                print("yes/no")
                inp = input("Enter your choice: yes/no ")
                if(inp == "yes"):
                    continue
                else:
                    break
    ...
    def DELETE_STUDENT_INFORMATION():
        ...
        if len(STUDENT_NAME) == 0 and len(STUDENT_ROLL_NUMBER) == 0 and len(STUDENT_AGE) == 0 and len(
                ...
                STUDENT_EMAIL) == 0 and len(STUDENT_RESULT) == 0:
            print("\n")
            ...
            STUDENT_RESULT.remove(STUDENT_RESULT[LOC])
    ...
    def UPDATE_STUDENT_INFORMATION():
        ...
        if len(STUDENT_NAME) == 0 and len(STUDENT_ROLL_NUMBER) == 0 and len(STUDENT_AGE) == 0 and len(
                STUDENT_CLASS) == 0 and len(STUDENT_MOBILE_NUMBER) == 0 and len(STUDENT_ADDRESS) == 0 and len(
                STUDENT_EMAIL) == 0 and len(STUDENT_RESULT_SYSTEM) == 0:
            print("\n")
            print("\t\t\t 'PLEASE FILL SOME INFORMATION DON'T KEEP IT EMPTY")
            print("\n")
        else:
            ...
            if ATTRIBUTE == 'NAME':
                ...
                print("ENTER 'OLD GRADE' :", end=" ")
                OLD_GRADE = input()
                LOC_RESULT = STUDENT_RESULT.index(OLD_GRADE)

                print("ENTER 'NEW GRADE' :", end=" ")
                NEW_GRADE = input()
                STUDENT_RESULT[LOC_RESULT] = NEW_GRADE
                print("\t 'GRADE UPDATED SUCCESSSFULLY.")
                print("\n")
    ...
    def DISPLAY_STUDENT_INFORMATION():
        ...
        if len(STUDENT_NAME) == 0 and len(STUDENT_ROLL_NUMBER) == 0 and len(STUDENT_AGE) == 0 and len(
            ...
            print("STUDENT'S GRADE :", end="\n")

            for y in STUDENT_RESULT:
                print(y)
            print()
